...
public class Block extends ConditionGroup implements ActionSet, ConditionSet
{
	...
	static
	{
		...
		actionmap.put("Pad","com.blueprintit.webfetch.v1.actions.PadAction");
		actionmap.put("Substitute","com.blueprintit.webfetch.v1.actions.SubstituteAction");
		actionmap.put("UserAgent","com.blueprintit.webfetch.v1.actions.UserAgentAction");
	}
